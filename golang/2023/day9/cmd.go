...
func RegisterCommand(parent *cobra.Command) {
	file1 := "input/2023/day9/input.txt"
	file2 := "input/2023/day9/input.txt"
	example := "input/2023/day9/example.txt"

	day9Cmd := &cobra.Command{
		Use: "9",
        Short: "Run Day 9 solutions",
	}
	...
	parent.AddCommand(day9Cmd)
	day9Cmd.AddCommand(partOneCmd)
	day9Cmd.AddCommand(partTwoCmd)
	day9Cmd.AddCommand(allCmd)
}
